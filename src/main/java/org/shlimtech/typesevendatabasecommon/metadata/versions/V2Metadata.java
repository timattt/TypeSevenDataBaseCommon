...
public class V2Metadata implements VersionedMetadataBuilder {

    private MetadataService metadataService;
    private final V1Metadata parent;
    ...
    public String getMetadataTemplatePath() {
        return "classpath:metadataVersions/v2.yaml";
    }
    ...
    public Metadata upgradeFromParentVersion(Metadata metadata) {
        return metadataService.generateMetadata(this);
    }
